window.onload = function () {
    ...
    chatBody.innerHTML += `
        <div class="message bot">
            <p>
                Hi! I’m VetBot, your virtual assistant. Welcome to Pawsitivevet2024! 
...
document.getElementById('sendMessage').addEventListener('click', function () {
    ...
    if (userInput !== '') {
        ...
        // Health and Wellness
            ...
            botResponse = "We recommend annual check-ups for healthy pets. Puppies and kittens may need more frequent visits for vaccinations and growth monitoring. Check our website for more info <a href='https://pawsitivevet2024.wordpress.com' target='_blank'>here</a>!";
        } else if (userInput.toLowerCase().includes('vaccination')) {
            botResponse = `Vaccinations are essential! Common ones include rabies, distemper, and parvovirus. For a detailed schedule, check out our article <a href="https://pawsitivevet2024.wordpress.com" target="_blank">Importance of Vaccinations for Pets</a>.`;
        } else if (userInput.toLowerCase().includes('deworming')) {
            botResponse = `Deworming is important for your pet's health. Learn more about it in our guide <a href="https://pawsitivevet2024.wordpress.com" target="_blank">The Importance of Deworming for Pets</a>.`;
        ...
        // Contact Information
            ...
            botResponse = "You can contact us through the 'Leave a Comment' section on our website <a href='https://pawsitivevet2024.wordpress.com' target='_blank'>here</a>. I'll get back to you as soon as possible!";
        }
        ...
        // Additional Questions
            ...
            botResponse = "We provide tips for basic training. You can also check our podcast series on canine behavioral problems <a href='https://pawsitivevet2024.wordpress.com' target='_blank'>here</a>.";
        }
